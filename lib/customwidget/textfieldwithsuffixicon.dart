...
class Textwithsuffixicon extends StatefulWidget {
  Textwithsuffixicon(this.name, this.icon);
  String name;
  IconData icon;
  @override
  State<Textwithsuffixicon> createState() => _TextwithsuffixiconState();
}

class _TextwithsuffixiconState extends State<Textwithsuffixicon> {
  @override
